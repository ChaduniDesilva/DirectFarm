...
<head>
    ...
    <style>
        ...
        * { box-sizing:border-box; }
        ...
        .sb-avatar { width:72px; height:72px; border-radius:50%; background:linear-gradient(135deg,var(--green),#006622); display:flex; align-items:center; justify-content:center; font-family:'DM Sans',sans-serif; font-size:26px; font-weight:700; color:white; border:3px solid #56ad58; }
        ...
        .sb-avatar-wrap:hover .sb-cam-overlay { opacity:1 !important; }
